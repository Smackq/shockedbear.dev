...
export function Header () {
    ...
    return (
        <header className="max-w-3xl w-full px-6 py-4 border-b border-white/10 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 text-white/70">
                ...
                <Link href="https://www.linkedin.com/in/denissmagin/" target="_blank" aria-label="Dribbble">
